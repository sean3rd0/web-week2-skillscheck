...
//Code here
function oddChecker (num){if (num % 2 === 1) return 'the number is odd'; else if (num % 2 === 0) return 'the number is even'}
...
// 		 let reversed = arr.splice[arr[i], 1]
// 	 }
// 	 return reversed
//  }
