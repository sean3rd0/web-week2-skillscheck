...
//Code Here
function iLove (name, love){return name + ' loves ' + love}; 
...
//Code Here
const me = {
	firstName: 'Sean', state: "UT", age: 24, greeter: function () {return `Hello! My name is ${me.firstName} and I live in ${me.state}`}
};
...
// Code Here
const doubled = myNumbers.map(function(value, index, array){
	return (value * 2)
});
...
// Code Here
const filtered = myNumbers.filter(function(value){
...
// Code Here
const total = myNumbers.reduce(function (accumulator, value){
...
notGeorge.map(function (value){
	forTheLoveOfGeorge.push(value = 'George');
});
...
// Code Here
let enemies = people.filter(function(value){
	return value.friend === false ? true : false
	// if (value.friend === false) {
	// 	return true} else {
	// 		return false
	// 	}
	}
...
// Code Here
let poobah = people.map(function(value) {
	return value.awesomeLevel
});

let totallyAwesome = poobah.reduce(function(accumulator, value){
	return accumulator + value
});
...
// const totallyAwesome = people.reduce(function (accumulator, value){
// 	accumulator + value
// }, 0); 