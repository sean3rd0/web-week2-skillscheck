...
// CODE HERE
const faveColors = ['white', 'green', 'blue'];
...
const me = {
    firstName: 'Sean', 
    superHeroName: 'Slimy Sean', 
    homeTown: 'East Millcreek', 
    superPowers: ['Infinite energy', 'Time-travel', 'Love'],
...
// CODE HERE
const setColor = arr => {arr.splice(3,arr.length-3)};
